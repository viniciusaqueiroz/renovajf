...
export default function Header() {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full px-3 pt-3 sm:px-4 sm:pt-4 xl:px-6">
      <div
        className={`mx-auto w-full max-w-6xl rounded-2xl border border-white/10 px-4 py-3 text-[#eef2ff] shadow-2xl shadow-black/25 backdrop-blur-xl transition-all duration-300 sm:px-6 ${
          isScrolled
            ? "bg-[#07111f]/85"
