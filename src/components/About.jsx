export default function About() {
  return (
    <section id="about" className="relative px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
          <div className="premium-panel h-full min-h-[320px] p-4 sm:p-5 lg:p-6">
            <div className="relative flex h-full items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_top,rgba(162,31,59,0.12),transparent_35%),linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.018))] p-5 sm:p-6">
              ...
              <img
                ...
                className="mx-auto w-full max-w-[170px] object-contain drop-shadow-[0_18px_38px_rgba(0,0,0,0.2)] sm:max-w-[190px] lg:max-w-[205px]"
              />
            </div>
          </div>

          <div className="premium-panel flex h-full min-h-[320px] flex-col justify-center p-5 sm:p-6 lg:p-8">
            <h3 className="font-montserrat text-2xl font-semibold text-white">
              Um pouco da nossa História
            </h3>
            <div className="mt-5 space-y-4 text-base leading-7 text-[#e5e7eb]/85">
              <p>
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 lg:mt-10">
          <div className="premium-card premium-card-hover flex min-h-[180px] flex-col justify-center p-5 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[34rem] text-sm leading-7 text-[#e5e7eb]/84 sm:text-base">
